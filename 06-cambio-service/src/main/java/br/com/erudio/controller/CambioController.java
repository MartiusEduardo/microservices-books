...
//	@RouterOperations({
//		@RouterOperation(method = RequestMethod.GET, operation = @Operation(description = "Find a specific book by your ID", operationId = "findBookByIdGET", tags = "Cambio Service API"))
//	})
